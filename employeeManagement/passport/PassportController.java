...
public class PassportController {
   ...
   * </p>
   * @param employeeId is used for get that employee's passport and edit that.
   */
    ...
    if(passport != null) {
      ...
      for (String s : fieldNumbers) {
        switch(Integer.parseInt(s)) {
          case 1:
            passportService.removePassport(passportId, employee);
            return;
          case 2:
   ...
   * Deletes the entire Passport.
	 * </p>
	 * @param employeeId is used for get employee details and remove passport from there.
	 * <p>
  ...
  public void removePassport(Employee employee) {
    int deleteId;
    if(employee != null) {
      deleteId = employee.getPassport().getId();
    } else {
      System.out.println("\nGiven employee not found\n");
			return;
    }
    if (passportService.getPassportIfExist(employee)!= null) {
      if (passportService.removePassport(deleteId, employee) != null) {
